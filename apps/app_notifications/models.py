...
class Notification(BaseModel):
    ...
    class NotificationType(models.TextChoices):
        ...
        APPLICATION_STATUS_CHANGED = 'APPLICATION_STATUS_CHANGED', '지원 승인/거절 알림'
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='notifications',verbose_name='유저',)
    content = models.CharField(max_length=300,verbose_name='알림 내용,')
    type = models.CharField(max_length=300,choices=NotificationType,verbose_name='알림 종류',)
    is_read = models.BooleanField(default=False, verbose_name='읽음 여부',)
    back_url_link = models.CharField(max_length=300,blank=True,null=True,verbose_name='이동URL',)
