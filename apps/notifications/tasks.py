...
async def _send_to_pubsub_async(notification_id: int) -> None:
    try:
...
def send_to_pubsub(notification_id: int) -> None:
    asyncio.run(_send_to_pubsub_async(notification_id))


async def _send_study_group_notification_async(notification_id: int, study_group_id: str) -> None:
    try:
...
def send_study_group_notification(notification_id: int, study_group_id: str) -> None:
    asyncio.run(_send_study_group_notification_async(notification_id, study_group_id))
