...
class AdminReviewListAPITests(_BaseFixtures):
    ...
    def _url(self) -> str:
        return reverse("admin_studies:admin-review-list")
...
class AdminReviewDetailAPITests(_BaseFixtures):
    ...
    def _url(self, review: Review) -> str:
        return reverse("admin_studies:admin-review-detail", kwargs={"review_id": str(self.review.pk)})
    ...
    def test_detail_review_not_found_404(self) -> None:
        ...
        res = self.client.get(reverse("admin_studies:admin-review-detail", kwargs={"review_id": 99999}))
        self.assertEqual(res.status_code, 404)
