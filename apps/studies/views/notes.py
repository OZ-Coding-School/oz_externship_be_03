...
class StudyNoteListAPIView(BaseResponseMixin, APIView):
    ...
    @extend_schema(tags="StudyGroupNotes", summary="스터디 노트 목록 조회 API")
...
class StudyNoteCreateAPIView(BaseResponseMixin, APIView):
    ...
    @extend_schema(tags="StudyGroupNotes", summary="스터디 노트 생성 API")
...
class StudyNoteDetailAPIView(BaseResponseMixin, APIView):
    ...
    @extend_schema(tags="StudyGroupNotes", summary="스터디 노트 단일 조회 API")
    ...
    @extend_schema(tags="StudyGroupNotes", summary="스터디 노트 수정 API")
    ...
    @extend_schema(tags="StudyGroupNotes", summary="스터디 노트 삭제 API")
